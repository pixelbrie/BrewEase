// seed.js: Spot where you manually create fake test data. When done with the tests, you may use teardown.js
// TODO: Add counter like you did in teardown.js
import { db } from '../config/firebaseAdmin.js';
import { Role, Employee } from '../models/index.js'; // TODO: Add customer stuff too

async function seedDatabase (){
  console.log("Starting the seed.js process...")
  ...
  console.log(`${newRole.roleId} added to roles.`)
  ...
  console.log(`${newEmployee.employeeId} added to employees.`)
  ...
  try {
    ...
    console.log('All seed data successfully added!');
    process.exit(0);
  } catch (error) {
